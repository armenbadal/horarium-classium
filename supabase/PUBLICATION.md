...
Ձեռքով՝ admin/scheduler-ով հրապարակել մեկ դասարան, փոխել անուն/ժամ/գույն/ուսուցիչ/մեկնաբանություն և տեսնել «Չհրապարակված փոփոխություններ», ստուգել որ public RPC-ն հին snapshot-ն է վերադարձնում, ապա նորից հրապարակել։ Փորձել դատարկ դասարան, պահպանման սխալ, կորած publication պատասխան և retry, երկրորդ ներդիրի հնացած version, այլ դպրոցի հաշիվ, anon draft read և հրապարակում ունեցող դասարանի ջնջում։
