...
- Ձեռքով թարմացում՝ պատուհանից կամ tray-ից։ Ձախողված refresh-ը չի ջնջում գործող դասացուցակը։
...
Tray-ի ընտրացանկը՝ «Բացել», «Թարմացնել դասացուցակը», checked «Ձայն» և «Խոսք», «Կարգավորումներ», «Ելք»։ Փոփոխությունները համաժամացվում են նույն պատուհանի կարգավորումների հետ և պահվում ֆայլում։ «Փորձարկել զանգը» կոճակը settings բաժնում է։
