...
- Դասացուցակը բեռնվում է միայն գործարկման ժամանակ, ոչ պարբերաբար։ Փոփոխությունները ստանալու համար վերագործարկեք ծրագիրը։ Cache-ը կարող է հնացած լինել․ UI-ն նշում է դրա օգտագործումը։
